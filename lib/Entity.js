 ...
 * @constructor
 * @param {?Array<number>=} position The position of the lower left corner of
 *   this Entity.
 * @param {?Array<number>=} velocity The velocity of this Entity.
 * @param {?Array<number>=} acceleration The acceleration of this Entity.
 * @param {?Array<number>=} hitboxSize The size of the hitbox of this entity.
 *   All entities will have a rectangular hitbox which is stored as
 *  [width, height] in this 2-tuple.
 * @param {?number=} orientation The orientation of the entity in radians.
 */
function Entity(position, velocity, acceleration, hitboxSize, orientation) {
  this.position = position || [0, 0];
  this.velocity = velocity || [0, 0];
  this.acceleration = acceleration || [0, 0];
  this.hitboxSize = hitboxSize || [0, 0];
...
/**
 * This method returns the width of the Entity (x direction).
 * @return {number}
 */
Entity.prototype.getWidth = function() {
  return this.hitboxSize[0];
};

/**
 * This method sets the width of the Entity (x direction).
 * @param {number} width The new width the the Entity.
 */
Entity.prototype.setWidth = function(width) {
  this.hitboxSize[0] = width;
};

/**
 * This method returns the height of the Entity (y direction).
 * @return {number}
 */
Entity.prototype.getHeight = function() {
  return this.hitboxSize[1];
};

/**
 * This method sets the height of the Entity (y direction).
...
Entity.prototype.update = function() {
  ...
  for (var i = 0; i < this.position.length; ++i) {
    ...
    this.position[i] = Util.bound(
        this.position[i], Constants.WORLD_MIN,
        Constants.WORLD_MAX - this.hitboxSize[i]);
